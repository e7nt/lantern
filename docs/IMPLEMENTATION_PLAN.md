...
the policy crate, capability negotiation, and `/trust`; Protocol v11 retains the
...
The maintained Protocol v11 product now exposes Pi's pinned coding-tool set in
