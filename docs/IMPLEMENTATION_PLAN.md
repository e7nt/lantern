...
the policy crate, capability negotiation, and `/trust`; Protocol v10 retains the
...
The maintained Protocol v10 product now exposes Pi's pinned coding-tool set in
