...
6. [Protocol v4](protocol/v4/README.md) before changing the terminal
...
- Preserve the editor/daemon boundary and keep provider-specific behavior in
  adapters.
- Treat Protocol v4 trust gates as transitional per ADR 003. Do not extend the
  capability system or preserve it as a fallback while building the trusted
