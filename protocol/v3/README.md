...
- Unknown methods, event types, fields, and capabilities are protocol errors.
...
Initialization must use protocol version `3`. A version mismatch is a hard
...
Protocol v3 replaces v2 by adding canonical workspace binding and explicit
capabilities. The v2 fixtures remain in the repository as historical contract
evidence; the maintained client and daemon do not negotiate it.
