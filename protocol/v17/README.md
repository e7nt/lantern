# Lantern Protocol v17

Protocol v17 makes the expanded Git canvas the sole owner of a code-review
...
After a successful correction, the one-shot agent Git focus handoff also
carries the submitted comments. The Git canvas renders them as a passive `Your
review` section beside the new diff and lets the developer navigate back to the
relevant code. This is context, not workflow state: it has no resolution flags,
approval requirement, or completion gate.
